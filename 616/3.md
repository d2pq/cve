...
UTT HiPER 840G router has a serious overflow vulnerability. An attacker can control the parameter  except through the route/goform/formP2PLimitConfig, which will cause a buffer overflow. Specifically, it can be achieved through "strcpy((char *)(InstPointByIndex_1 + 48), src);" to cause a denial of service attack.

# Vulnerability details

The API for invoking the function

![image-20250616220800242](3/image-20250616220800242.png)



Here you can control the except parameter to achieve stack overflow

![image-20250616220816554](3/image-20250616220816554.png)
...
![image-20250616185348333](3/image-20250616185348333.png)